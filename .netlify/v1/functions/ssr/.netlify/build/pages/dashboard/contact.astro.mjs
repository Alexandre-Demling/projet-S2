...
const $$Contact = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Contact - Orbite Dashboard" }, { "default": ($$result2) => renderTemplate` ${renderComponent($$result2, "HeaderDashboard", $$HeaderDashboard, {})}  ${maybeRenderHead()}<section class="bg-gradient-to-b from-purple-950 via-purple-900 to-black min-h-screen pt-20"> <div class="max-w-4xl mx-auto px-4 py-16"> <!-- Header --> <div class="text-center mb-16"> <h1 class="text-4xl md:text-5xl font-bold text-white mb-6">
Contactez-nous
</h1> <p class="text-xl text-purple-200 max-w-2xl mx-auto">
Une question ? Une suggestion ? Nous sommes là pour vous aider !
</p> </div> <!-- Contact Form --> <div class="max-w-2xl mx-auto"> <div class="bg-purple-800/30 rounded-2xl p-8 backdrop-blur-sm border border-purple-700/50"> <form class="space-y-6" action="https://formspree.io/f/xjkwqrve" method="POST"> <input type="hidden" name="_subject" value="Nouveau message depuis Orbite Dashboard"> <div> <label for="name" class="block text-sm font-medium text-white mb-2">
Nom complet
...
</p> </div> </div> </div> </div> </section> ${renderComponent($$result2, "FooterDashboard", $$FooterDashboard, {})} ` })}`;
}, "C:/Users/alexa/Documents/orbite-astro/src/pages/dashboard/contact.astro", void 0);

const $$file = "C:/Users/alexa/Documents/orbite-astro/src/pages/dashboard/contact.astro";
