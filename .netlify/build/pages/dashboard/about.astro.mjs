...
Continuez l'aventure Orbite !
</h3> <p class="text-purple-200 mb-6 leading-relaxed">
Découvrez de nouveaux événements, créez vos propres activités et 
            connectez-vous avec d'autres étudiants passionnés.
</p> <a href="/dashboard" class="bg-yellow-400 hover:bg-yellow-300 text-black font-bold py-4 px-8 rounded-lg text-lg transition-all duration-300 transform hover:scale-105 shadow-lg inline-block">
Retour au dashboard
</a> </div> </div> </div> </section> ${renderComponent($$result2, "FooterDashboard", $$FooterDashboard, {})} ` })}`;
}, "C:/Users/alexa/Documents/orbite-astro/src/pages/dashboard/about.astro", void 0);

const $$file = "C:/Users/alexa/Documents/orbite-astro/src/pages/dashboard/about.astro";
const $$url = "/dashboard/about";
